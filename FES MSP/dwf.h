...
/*    Copyright 2013-2019 Digilent Inc.                                 */
/************************************************************************/
/*  File Description:                                                   */
/*                                                                      */
...
/*  08/19/2019(KovacsLA) : replacing BOOL and BYTE types                */
/*                                                                      */
/************************************************************************/
...
DWFAPI int FDwfAnalogOutNodeFunctionInfo(HDWF hdwf, int idxChannel, AnalogOutNode node, int *pfsfunc); // use IsBitSet
...
DWFAPI int FDwfAnalogOutFunctionInfo(HDWF hdwf, int idxChannel, int *pfsfunc); // use IsBitSet
